...
public class SlotBookPage extends WaitsMethod {

	WebDriver driver;
//	Page Factory

	public SlotBookPage(WebDriver driver) {
...
//	Locators
	...
	public void EnterAddress() throws InterruptedException {
		explicitWaitOnSendkeys(driver,Address,2,"Tayal");
	}
	public void EnterCity() throws InterruptedException {
		explicitWaitOnSendkeys(driver,city,2,"Bulandshahr");
	}
	public void EnterState() throws InterruptedException {
		explicitWaitOnSendkeys(driver,state,2,"Uttar Pardesh");
	}
	public void EnterZip() throws InterruptedException {
		explicitWaitOnSendkeys(driver,zip,2,"203001");
	...
	public void EnterCardNumber() throws InterruptedException {
		explicitWaitOnSendkeys(driver,ccn,2,"0987654321");

	}
	public void EnterCardMonth() throws InterruptedException {
		explicitWaitOnSendkeys(driver,com,2,"09");

	}
	public void EnterCardYear() throws InterruptedException {
		explicitWaitOnSendkeys(driver,coy,2,"Bulandshahr");

	}
	public void EnterCardName() throws InterruptedException {
		explicitWaitOnSendkeys(driver,cardname,2,"Shivam Tayal");
